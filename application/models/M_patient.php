...
WHERE mkt_posting_pack_h.id_quot IN ('.$param.') 
	...
	function get_mark_mcu_lab2($id_pat,$id,$previous,$last){ // Fungsi ini dibuat untuk melihat radiologi, add by rangga 11 Febuari 2016
	...
	function get_mark_mcu_lab($id_pat,$id,$previous,$last){ // Fungsi ini dibuat untuk melihat radiologi, add by rangga 11 Febuari 2016
