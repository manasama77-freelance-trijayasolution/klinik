...
WHERE `atasan_1` = '$id' ;");
	...
	function get_list_services_lab_q($id,$group){ //========== Note : saya rangga membuat ini untuk group lab pada qoutation.
	...
	function get_list_services_rad_q($id,$group){ //========== Note : saya rangga membuat ini untuk group Radiology pada qoutation.
