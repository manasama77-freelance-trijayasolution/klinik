                ...
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            ...
                            <?php }
                            if ($jobs == 5 || $jobs == 13 || $userlevel == "master") { ?>
                                <li class="dropdown">
...
-->
            ...
            if (
                mysqli_num_rows($result2) != 0 || mysqli_num_rows($result5) != 0 || mysqli_num_rows($result6) != 0 || mysqli_num_rows($result7) != 0 || mysqli_num_rows($result8) != 0 || mysqli_num_rows($result9) != 0 || $jumlah10 != 0
                    ...
                    <ul>
                        ...
                        <?php while ($row7 = mysqli_fetch_assoc($result7)) { ?>
                            <div>
                                <li>
                                    <?php if ($userlevel == "master" || $userlevel == "supervisor") { ?>
                                        <a href="<?php echo base_url(); ?>marketing/list_quotation_app"><?php } ?> <span>Request Approval Quotation : <?= $row7['qout_id']; ?><?php if ($row7['quot_revision'] > 1) {
                                                                                                                                                                                    echo "/Rev-" . $row7['quot_revision'];
                                                                                                                                                                                } ?> - By <b><?= $row7['fullname']; ?></b>, <?= time_elapsed_string($row7['quot_date_create']); ?></a></span>
                                </li>
                            </div>
