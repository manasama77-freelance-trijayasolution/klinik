...
<!-- 
 ...
 -->
			            ...
			            <tr class="odd gradeX">
			              ...
			              <td>Insurance</td>
			              <td>
			              	<select class="chzn-select" name="bank_ins" id="bank_ins" style="width:350px;" >
       ...
       <!--/.fluid-container-->
		...
		<script>
			<?php 
			$num_payment_before		= $payment_before->num_rows();
			if ($num_payment_before > 0) { 
			?>
	            $(function() {
				window.onload = $.jGrowl("<b>Last Transaction</b> : </br> <?php $aa=1; foreach($payment_before->result() as $row_last_prec){ echo $aa++.". ".number_format($row_last_prec->amount,2).", <span style='font-size: 85%'> ".time_elapsed_string1($row_last_prec->create_date)."</span></br>"; } ?> ", { sticky: true });
