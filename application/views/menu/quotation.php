                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in" style="display:none;" id="locked">         
                                      <fieldset>
										...
										<b>Manual Book : Quotation</b></br>
										<iframe style="border-radius:8px;" width="185px" height="184px" src="https://www.yumpu.com/id/embed/view/WiQRYJqK7tVwdFxc" frameborder="0" allowfullscreen="true" allowtransparency="true"></iframe>
										</div> -->
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
										  <!-- <select style="width: 125px;" name="1">
										  <option value="MCU">MCU</option>
										  <option value="MCO">MCU ONSITE</option>
										  <option value="VAC">VACCINE</option>
										  </select>  
										   <input type="text" value="<?=$hasilnya;?>" name="20" style="width: 35px;" readonly> - 
										  /<b><?=romanic_number(date('m'));?></b>/<b><?=date('Y');?></b>
										  -->
										  <input class="input-small focused"  style="width: 45px;" placeholder="..." name="3" type="hidden" id="0" autocomplete="off" disabled required>  
										  <input type="hidden" name="1" value="<?=romanic_number(date('m'));?>/<?=date('Y');?>">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-small" name="qty" id="qty" onkeyup="loadgrandtotal4();" type="number" autocomplete="off" required> <i class="icon-user"></i> <b>Pax</b>
                                          </div>
                                        </div>
										</div>
										</br>	
										...
										<table class="table table-hover" id="example2">
											...
											<tr>
												...
												<tr>
													...
													<option value='0'>- Choose Lab Group -</option>
													<?php 
													...
													<font  id="bbgrlab1" color='red' style='display:none;'> * </font>
													<!-- BATAS UNTUK GROUP LAB -->
													<!-- UNTUK GROUP RADIOLOGI -->
													...
													<font  id="bbgrrad1" color='red' style='display:none;'> * </font>
													<!-- BATAS UNTUK GROUP RADIOLOGI -->
													<select id='cc1' name='three_1' style='width: 190px; display:none;'>
												...
												<tr>
													...
													<td><div id="penutup_persen_adm_1" style="display:none;">
													<input class="input-xlarge-in focused" id="persen_adm[1]" name="persen_adm_amount[1]" value="0" style="width:45px; text-align:right display:none;"" autocomplete="off" max="100" type="number" onkeyup="persen_adm(1);" > <b>%</b>				
													</div> </td>
												</tr>
												</table>									
												</TD>
												...
												<tr>
													<td>
													<INPUT id="total[1]" name="price[1]" value="0" style="width:145px; text-align:right" onmouseover="loadgrandtotal('example2');" type="text" onchange="setBlurFocus(1);" readonly onkeyup="persen_adm2(1);">
													</br>
