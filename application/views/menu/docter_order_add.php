	...
	?>	
		...
		function popup(b_id){
			window.open("<?php echo base_url();?>patient/find_pat_doc","Popup","height=800, width=1400, top=1, left=1 ");
		}
		...
		<div class="span12">
		<form class="form-horizontal" action="<?php echo base_url();?>docter/doctor_order_act_add" method="post" name="mst_pr">
