					...
					<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Item List </div>
                            </div>
                                ...
                                <div class="span12">
                                   ...
                                   <table class="table table-hover">
										...
										foreach($data->result() as $row){
											$jumlah=$jumlah+$row->stock
										?>
											<tr class="odd gradeX">
												<td><?=$i++;?></td>
												<td><?php echo $row->item_name;?></td>		
												<td><?php echo $row->warehouse_name;?></td>	
												<td><?php echo number_format($row->stock);?> - <?php echo $row->baseunit;?></td>	
											</tr>
										</form>
										<?php
										}
								   ...
								   <table class="table table-striped table-bordered">
											<tr class="odd gradeX">
											<td><div align="right"><b>Total Stock</b> <INPUT class="input-xlarge-in focused" onkeydown="loadgrandtotal('example2');" id="total"  name="amount_grand" value="<?php echo number_format($jumlah); ?>" style="width:145px; text-align:right" type="text" readonly></div></td>
											</tr>
									</table>     
                                </div>
                            </div>
