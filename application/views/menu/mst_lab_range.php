	...
	low 	= spl[1];
      ...
      function delete_item(id){
		...
		if (r == true) {
			// x = window.location = "<?php echo base_url();?>lab/delete_item_range/"+id+"";
			$.post("delete_item_range/"+id+"", $("#console").serialize()); // silent delete..
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                      <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>lab/save_item_range" method="post" name="mst_lab">							
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select class="chzn-select" name="lab_item" id="1" required disabled>
											  ...
											  ?>
												<option value="<?=$rows->id_lab_item?>:<?=$rows->lab_item_case?>" align="justify"><?=$rows->lab_item_abbr?></option>
											  <?php
											  }
											  ?>
                                            </select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" style="width: 90px;" name="range_1" type="text" id="3" autocomplete="off" placeholder="Months" disabled> to <input class="input-xlarge focused" style="width: 90px;" name="range_2" type="text" id="4" autocomplete="off" placeholder="Months" disabled>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" style="width: 90px;" placeholder="Low" name="low_limit" type="text" id="5" autocomplete="off" disabled > and  <input class="input-xlarge focused" style="width: 90px;" placeholder="High" name="high_limit" type="text" id="6" autocomplete="off" disabled>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" style="width: 90px;" name="min_limit" placeholder="Low Min" type="text" id="7" autocomplete="off" disabled> and <input class="input-xlarge focused" style="width: 90px;" name="max_limit" placeholder="High Max" type="text" id="8" autocomplete="off" disabled>
                                          </div>
                                        </div>
										</div>
										...
										<div id="myAlert" class="modal hide">
											...
											<div class="modal-footer">
												<input type="submit" class="btn btn-success" id="9" value="Save">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										?>
											<tr class="odd gradeX">
												...
												<td>
												<button onclick="change_pat(<?php echo $row->id_lab_item_range;?>);" class="btn btn-warning btn-mini"><i title="Update Range" class="icon-edit"></i></button>
												<button class="btn btn-danger btn-mini" id="del<?php echo $row->id_lab_item_range;?>" onclick="delete_item(<?php echo $row->id_lab_item_range;?>);"><i title="Delete Range" class="icon-trash"></i></button>
												</td>
											</tr>
										</form>
										<?php
