	...
	?>
		<div class="alert alert-success">
			...
			<strong>Success!</strong> Input Questionnaire Treadmill
		</div>
	<?php
		} else if ($id=="change") {
	?>
		<div class="alert alert-success">
			<button class="close" data-dismiss="alert">&times;</button>
			<strong>Success!</strong> Update Data Questionnaire Treadmill
	    </div>
	<?php
		} else if ($id=="del") {
	?>
		...
		window.location.href = "<?php echo base_url();?>patient/quesioner_patient_tread/edit";
					...
					<div class="navbar">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left">Form Questionnaire Treadmill</div>
                            </div>
													...
													<div class="span12">
														<table class="table table-hover">
															...
															<tbody>
																<tr>
																	<td>1</td>
																	<td>Blood Pressure > 140/90 mmHg</td>
																	<td><input type="radio" name="bp" value="1" required></td>
																	<td><input type="radio" name="bp" value="0" required></td>
																</tr>
																<tr>
																	<td>2</td>
																	<td>Heart Rate > 120x /minutes</td>
