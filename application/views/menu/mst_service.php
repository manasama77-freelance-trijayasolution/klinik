					...
					<form class="form-horizontal" action="<?php echo base_url(); ?>marketing/save_mst_service" method="post" name="mst_service">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input type="hidden" name="price_3" id="3b" value="" class="input-xlarge-i focused" autocomplete="off">
								<input type="hidden" name="type_3" id="tae" value="3">

								<input type="hidden" name="curr_type_4" id="curr" value="IDR">
								<input type="hidden" name="price_4" id="4b" value="" class="input-xlarge-i focused" autocomplete="off">
						...
						<!-- 
									...
									<div class="control-group">
										...
										<select class="chzn-select"  name="type_1" id="tae" style="width: 160px;">
											...
											?>
											<option value="<?= $rows->id_price_type ?>" <?php if ($rows->id_price_type == "1") {
																							echo "selected";
																						} ?> align="justify"><?= $rows->price_type ?></option>
											<?php
											}
											?>
											</select>	
										...
										<select class="chzn-select"  name="type_2" id="tae" style="width: 160px;">
											...
											foreach ($pay_type->result() as $rows) {
											?>
											<option value="<?= $rows->id_price_type ?>" <?php if ($rows->id_price_type == "2") {
																							echo "selected";
																						} ?> align="justify"><?= $rows->price_type ?></option>
											<?php
											}
										...
										<select class="chzn-select"  name="type_3" id="tae" style="width: 160px;">
											...
											foreach ($pay_type->result() as $rows) {
											?>
											<option value="<?= $rows->id_price_type ?>" <?php if ($rows->id_price_type == "3") {
																							echo "selected";
																						} ?> align="justify"><?= $rows->price_type ?></option>
											<?php
											}
										...
										<select class="chzn-select"  name="type_4" id="tae" style="width: 160px;">
											...
											foreach ($pay_type->result() as $rows) {
											?>
											<option value="<?= $rows->id_price_type ?>" <?php if ($rows->id_price_type == "5") {
																							echo "selected";
																						} ?> align="justify"><?= $rows->price_type ?></option>
											<?php
											}
										...
										<select class="chzn-select"  name="type_5" id="tae" style="width: 160px;">
											...
											foreach ($pay_type->result() as $rows) {
											?>
											<option value="<?= $rows->id_price_type ?>" <?php if ($rows->id_price_type == "6") {
																							echo "selected";
																						} ?> align="justify"><?= $rows->price_type ?></option>
											<?php
											}
