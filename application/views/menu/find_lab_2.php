  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										?>
											<tr class="odd gradeX">
												...
												<td><a href="" onclick="closeit('<?=$row->serv_name;?>:<?=number_format($row->price,2);?>:<?=$row->id_service;?>:<?=$row->id_service;?>:<?=$row->price;?>:<?=$row->order_id;?>:<?=$row->order_type;?>:<?=$row->group_name;?>');"><button class="btn btn-success btn-mini"><i class="icon-tags"></i></button></a></td>
											</tr>
										</form>
										<?php
										}
