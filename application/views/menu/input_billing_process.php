				...
				<div id="rootwizard">
					...
					<div class="tab-pane active" id="tab1" onmouseover="loadtotalamount(1);">
			            ...
			            <table class="table table-bordered">
			                ...
			                <tr class="odd gradeX">
			                <td><div align="right"><b>Disc</b> <input id="disc" name="disc" type="number" max="100" min="0" value="0" style="width:40px" onkeyup="hitungdisc(1);" onclick="if(this.value==0) this.value='';" onblur="javascript: if(this.value==''){this.value=0;}" autocomplete="off"/> % <input id="totdisc1" name="totdisc1" class="input-xlarge-i focused" type="text" style="width:145px; text-align:right" value="0" onchange="hitungpersen(1);"  onclick="if(this.value==0) this.value='';" onblur="javascript: if(this.value==''){this.value=0;}" autocomplete="off"/> <input class="input-xlarge-i focused" style="width:145px; text-align:right" id="jmldisc1" name="jmldisc1" type="hidden" value="0" autocomplete="off"/> </div></td>
			                </tr> 
			                <tr class="odd gradeX">
					...
					<div class="tab-pane" id="tab2" onmouseover="loadtotalamount(2);">
			            ...
			            <?php if ($split_trxbd  == 2) { $tongji3 = ""; }else{ $tongji3 = "disabled"; } ?>
			              <div class="btn-group">
					...
					<div class="tab-pane" id="tab3" onmouseover="loadtotalamount(3);">
			            ...
			            <table class="table table-bordered">
			                ...
			                <tr class="odd gradeX">
			                <td><div align="right"><b>Disc</b> <input id="discc" name="discc" type="number" max="100" min="0" value="0" style="width:40px" onkeyup="hitungdisc(3);" onclick="if(this.value==0) this.value='';" onblur="javascript: if(this.value==''){this.value=0;}" autocomplete="off"/> % <input id="totdisc3" name="totdisc3" class="input-xlarge-i focused" type="text" style="width:145px; text-align:right" value="0" onchange="hitungpersen(3);" onclick="if(this.value==0) this.value='';" onblur="javascript: if(this.value==''){this.value=0;}" autocomplete="off"/> <input class="input-xlarge-i focused" style="width:145px; text-align:right" id="jmldisc3" name="jmldisc3" type="hidden" value="0" autocomplete="off"/> </div></td>
			                </tr>
			                <tr class="odd gradeX">
        ...
        $(function() {
			...
			$('.notification').ready(function() {
				...
				switch($id) {
					...
					if ($disave == "disabled") {
					?>
						$.jGrowl("<span class='label' data-original-title='You'><i class='icon-lock' ></i></span> <b>WARNING</b> :</br></br>one of item does not have a price, please contact the admin or finance</br>", { sticky: true });
					<?php } ?>
					break;
				}
			});
