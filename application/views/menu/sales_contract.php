				...
				<body onload="startTime()">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>New Sales Contract</b></div>
							...
							<div class="btn-group">
							 ...
							 <ul class="dropdown-menu">
								...
								<li><a href="<?php echo base_url();?>marketing/group_package"><i class="icon-th-large"></i> Master Group Package</a></li>
                                      ...
                                      <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>marketing/save_sales_contract" method="post" name="quotation">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											<input class="input-xlarge focused" name="dates" type="text" autocomplete="off" value="" placeholder="example : Jakarta, 30 Juni 2016" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="pic_name" placeholder="PIC Name" type="text" autocomplete="off" value="" required> <input class="input-small focused" placeholder="Telephone" name="pic_telp" type="text" autocomplete="off" value="" required> <input placeholder="Mobile Phone" class="input-small focused" name="pic_hp" type="text" autocomplete="off" value="" required> <input placeholder="Email" class="input-medium focused" name="pic_email" type="text" autocomplete="off" value="" required></br></br>
                                          </div>
                                        </div>
											...
											<div class="row-fluid">
												...
												<div class="block">
													...
													<div class="block-content collapse in">
														<textarea name="message_m" id="ckeditor_full"></textarea>
													</div>
												</div>
												<!-- /block -->
											</div>
