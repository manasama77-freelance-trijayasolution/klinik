                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
									...
									<form class="form-horizontal" action="<?php echo base_url();?>smart/save_item_aja" method="post" name="mst_service">
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Group Services</label>
                                          <div class="controls">
                                          <input type="hidden" name="id_smart" value="<?=$id_smart;?>" />
                                          <input type="hidden" name="id_group" value="<?=$type_id;?>" />
                                          <input type="text" name="grp_services" value="<?=$group_desc;?>" readonly/>
                                          </div>
										</div>
										<div class="control-group">
                                          <label class="control-label" for="focusedInput">Services Name</label>
                                          <div class="controls">
                                          <input type="text" name="serv_name"  value="<?=$serv_name;?>" readonly/>
