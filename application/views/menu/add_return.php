                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                    <fieldset>
									<form class="form-horizontal" action="<?php echo base_url();?>inv/save_return" method="post" name="quesioner_mcu">
										<div class="row-fluid">
											<!-- block -->
											<?php
...
<tr class="odd gradeX">
	...
	<td>
		<input class="input-xlarge datepicker" style="width: 80px;" id="[<?=$dates++;?>]" name="dates[<?=$dates_1++;?>]" placeholder="Click Here ..." type="text"></td>		
	<td>
	...
	<td><INPUT id="input[<?=$input++;?>]" name="input[<?=$input_1++;?>]" type="number" onkeyup="totalise(<?=$total++;?>);" value="<?php echo $row->conv_factor;?>" style="width:45px" readonly/> <?php echo $row->source;?> - <INPUT id="input_2[<?=$inputt++;?>]" name="input_2[<?=$inputtt++;?>]" type="number" onkeyup="totalise(<?=$totall++;?>);" value="0" min="0" max="<?php echo $row->qty_rev;?>" style="width:45px"/> <?php echo $row->unit;?>
		<INPUT name="id_detail_rcv[<?=$id_detail_rcv++?>]" type="hidden" value="<?php echo $row->id_detail_rcv;?>"/>
	</td>
...
?>
																...
																<div class="span12">
											 					<textarea name="comment" id="comment" style="width: 950px; height: 100px;"></textarea>
														</div>
													</div>
												</div>
											</div>
