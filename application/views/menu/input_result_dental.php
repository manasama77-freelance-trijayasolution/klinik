	...
	<script>
	  ...
	  function popup(b_id){
		window.open("<?php echo base_url();?>patient/find_patient_dental","Popup","width=1400, height=700, top=50, left=10"); 
      }
		...
		window.location.href = "<?php echo base_url();?>patient/quesioner_patient_mcu/edit";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Input Result Dental (Doctor)</b></div>
							<div class="muted pull-right" id="txt" style="font-weight: bold;"></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">           
                                    <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>patient/input_result_dental_act" method="post" name="mark_mcu">
