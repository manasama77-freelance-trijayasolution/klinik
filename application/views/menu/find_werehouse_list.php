				<script type="text/javascript">
					...
					window.opener.document.forms['mst_service'].elements['warehouse_name'].value=myarr[0];
					window.opener.document.forms['mst_service'].elements['id_warehouse'].value=myarr[1];
					window.opener.document.forms['mst_service'].elements['stock'].value=myarr[2];
					window.opener.document.forms['mst_service'].elements['item_move'].max=myarr[2];
					window.close(this);
						}
				</script>
				<?php
