                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Returnt Items Detail</b></div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
									...
									<form class="form-horizontal" action="<?php echo base_url();?>Pharmacy/save_trx_undispensed" method="post" name="quesioner_mcu">
										<div class="row-fluid">
...
<tr class="<?=$nilai;?>">
	<td><?php echo $i++;?></td>
	<td>
		<i>[<?=$row->drug_group;?>]</i> <b><?php echo $row->item_name;?></b><?php if($row->drug_potekan!=0){ ?></br><p><?=$row->drug_potekan;?> Tablet <?=$row->drug_dtd;?>  d.t.d</p><?php }?>
	</td>
	...
	<td>
		...
		<input type="hidden" name="id_presc_d[]" value="<?php echo $row->id_presc_d;?>"/>
