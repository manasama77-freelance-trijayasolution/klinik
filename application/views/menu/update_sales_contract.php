  ...
  -webkit-transform: rotateY(20deg);
				...
				<body onload="startTime()">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Update Sales Contract</b></div>
							...
							?>
                                    <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>marketing/update_sc/<?=$id;?>" method="post" name="quotation">
										<!--<div id="" style="overflow-y: scroll; height:260px;">-->
										<div class="control-group">
                                          <label class="control-label" for="focusedInput">No. Quotation</label>
                                          <div class="controls">
										  <input class="input-xlarge focused" name="no_quot" type="text" value="<?=$row->qout_id?>" id="0" autocomplete="off" value="" required readonly>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
										  <input class="input-xlarge focused" name="pack_name" value="<?=$row->quot_name?>" type="text" id="1" autocomplete="off" value="" required readonly>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											<input class="input-xlarge focused" name="kompeni" value="<?=$row->client_name?>" type="text" autocomplete="off" value="" required readonly>
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <label class="control-label" for="select01">Dates</label>
                                          <div class="controls">
											<input class="input-xlarge focused" name="dates" type="text" autocomplete="off" value="<?=$row->dates_loc?>" placeholder="example : Jakarta, 30 Juni 2016" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="pic_name" value="<?=$row->attn_name?>" placeholder="PIC Name" type="text" autocomplete="off" value="" required> <input class="input-small focused" placeholder="Telephone" value="<?=$row->attn_tlp?>"  name="pic_telp" type="text" autocomplete="off" value="" required> <input placeholder="Mobile Phone" class="input-small focused" name="pic_hp" value="<?=$row->attn_mobile?>"  type="text" autocomplete="off" value="" required> <input placeholder="Email" value="<?=$row->attn_email?>"  class="input-medium focused" name="pic_email" type="text" autocomplete="off" value="" required></br></br>
                                          </div>
                                        </div>
										...
										<div class="span12" id="content">
											<div class="row-fluid">
												...
												<div class="block">
													<div class="navbar navbar-inner block-header">
														<div class="muted pull-left"><b>Messages</b></div>
													</div>
													<div class="block-content collapse in">
														<textarea name="message_m" id="ckeditor_full"><?=$row->message?></textarea>
													</div>
												</div>
												<!-- /block -->
											</div>
    ...
    <script src="<?php echo base_url();?>design/assets/scripts.js"></script>
        ...
        $(function() {
            ...
            $( 'textarea#ckeditor_full' ).ckeditor({width:'99%', height: '350px'});
        });
