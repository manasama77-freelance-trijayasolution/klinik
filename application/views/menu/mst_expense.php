	...
	<script language="javascript">
        function addRow(tableID) {
			...
			cell3.innerHTML = "<input type='text' id='a"+cell2.innerHTML+"' name='item["+cell2.innerHTML+"]' placeholder='item(s) Klik Here' style='width:185px' required>  ";

			var cell4 		= row.insertCell(2);
			cell4.innerHTML = "<input name='id_base["+cell2.innerHTML+"]' id='id_base["+cell2.innerHTML+"]' type='hidden' value='0'/> <input id='base["+cell2.innerHTML+"]' name='base["+cell2.innerHTML+"]' style='width:100px' type='hidden' /> </br> <input name='vestige["+cell2.innerHTML+"]' id='vestige["+cell2.innerHTML+"]' type='hidden' value='0' /> <input id='conv_id["+cell2.innerHTML+"]' name='conv_id["+cell2.innerHTML+"]' style='width:45px' type='hidden' />  <input type='text' onkeyup='totalise("+cell2.innerHTML+");loadgrandtotal(example2);' name='qty["+cell2.innerHTML+"]' id='qty["+cell2.innerHTML+"]' placeholder='Qty' style='width:45px'> <input id='convq["+cell2.innerHTML+"]' name='convq["+cell2.innerHTML+"]' onkeyup='totalise("+cell2.innerHTML+");loadgrandtotal('example2');' style='width:45px'  type='hidden' /> <input id='hasil["+cell2.innerHTML+"]' name='hasil["+cell2.innerHTML+"]' type='hidden' />  ";								
			...
			cell6.innerHTML = "<input id='disc["+cell2.innerHTML+"]' name='disc["+cell2.innerHTML+"]' onkeyup='totalise("+cell2.innerHTML+");loadgrandtotal('example2');' value='0' placeholder='0 %' style='width:25px' max='99' min='1' type='text'> <b>%</b> </br> <input id='disc_2["+cell2.innerHTML+"]' value='0' name='disc_2["+cell2.innerHTML+"]' onkeyup='totalise2("+cell2.innerHTML+");loadgrandtotal('example2');' placeholder='Amount' style='width:95px; text-align:right;' type='text'> <b>IDR</b>";
	...
	?>
                    ...
                    <div class="row-fluid" >
                    <!-- <div class="row-fluid" onmouseover=" ('example2');" > -->
                        <!-- block --> 
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left"><b>Expense</b></div>
						 		 ...
						 		 <button onclick="undisableTxt()" class="btn btn-primary">Start</button> 										 
									 <div class="btn-group">
									  ...
									  <ul class="dropdown-menu">
										<li><a href="<?php echo base_url();?>inv/list_expense"><i class="icon-list"></i> List Expense</a></li>
									  </ul>
									 </div>
                                ...
                                <div class="span12">           
                                      <fieldset>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
										  <input name="no" type="text" id="2" autocomplete="off" value="">
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge datepicker" id="3" name="date_delivery" placeholder="Click Here ..." type="text" autocomplete="off" required> <i class="icon-calendar"></i> 
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
										  <input id="name_supplier" name="name_supplier" type="text" id="1">
                                          </div>
                                        </div>
								...
								<input class="btn btn-danger" type="button" value="Delete" onclick="deleteRow('example2')" />			
										...
										<table class="table table-striped table-bordered" id="example2" onkeydown="loadgrandtotal('example2');">
											...
											<tr class="odd gradeX" id="voucher_">
												<td>1</td>
												<td>
													<input type="text" name="item[1]" style="width:185px"  placeholder="item(s) Click Here" id="a1" required/>
												</td>
												<td>
												...
												<td align="center">
													...
													<!-- <input id="unitx[1]" name="unitx[1]" type="text"/> -->
													<p id="tampil[1]"></p>
												</td>
												<td>
													<input id="disc[1]" name="disc[1]" max="99" min="1" type="text" onkeyup="totalise(1);loadgrandtotal('example2');" placeholder="0 %" value="0" style="width:25px"/>  <b>%</b> </br>
													<input id="disc_2[1]" name="disc_2[1]" class="input-xlarge-i focused" type="text" onkeyup="totalise2(1);loadgrandtotal('example2');" placeholder="Amount" style="width:95px; text-align:right" value="0"/> <b>IDR</b>
												</td>
												<td>
