				...
				if (isset($_POST['comment_rad'])) {
					$hasil_comment_rad = "";
					$cars = $this->input->post('comment_rad');
					if (isset($cars)){
						$hasil_comment_rad = implode(' | ', $cars);
					}
					echo  "<script type='text/javascript'>";
          // echo "window.opener.document.forms['mark_mcu'].elements['comment_final".$link."'].value='".$hasil_comment_rad."';";
					echo "window.opener.document.forms['mark_mcu'].elements['comment_final'].value='".$hasil_comment_rad."';";
					echo "window.close();";
					echo "</script>";
				}
                ...
                <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
          					...
          					<div id="" style="overflow-y: auto; height:1200px;">
          					<div class="control-group">
                              <label class="control-label" for="focusedInput"><b>Typing a Comment : </b></label>
                              <div class="controls">
								<select multiple="multiple" id="multiSelect" name="comment_rad[]" class="chzn-select" style="width: 250px;">
