	...
	<script>
      ...
      function update_item(id){
		window.open("<?php echo base_url();?>inv/update_inv_item/"+id+"","Popup","height=610, width=980, top=50, left=210 ");
      	// window.location = "<?php echo base_url();?>inv/inv_item/update/"+id+"";
      }
		...
		$('.input-xlarge-i').autoNumeric('init');
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Update Master Item</b></div>
                            </div>	
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
										<form class="form-horizontal" action="<?php echo base_url();?>inv/update_master_item" method="post" id="form_sample_1" name="mst_service">
