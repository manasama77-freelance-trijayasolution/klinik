                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                      ...
                                      ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo $row->quot_name;?></td>
                                                <td><?php echo $months[$row->bulan];?></td>
                                                <td><?php echo $row->tahun;?></td>
                                                <td><?php echo $row->jml;?></td>
                                                <td>
                                                  <button class="btn btn-info btn-mini" title="View Year">
                                                  <a href="<?php echo base_url();?>docter/list_report_mcu_detail/<?=$id_company;?>/<?=$id_package;?>/<?=$row->bulan;?>/<?=$row->tahun;?>" target="_blank">
                                                  <i class="icon-list"></i>
                                                  </a>
                                                  </button>
                                                </td>
