				...
				<script type="text/javascript">
					...
					window.opener.document.forms['mst_pr'].elements['qty[<?=$link;?>]'].max=myarr[1];
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										?>
											<tr class="odd gradeX">
												...
												<td><a href="" onclick="closeit('<?=str_replace("'","",$row->item_name);?>:<?=$row->item_curr_qty;?>:<?=$row->baseunit;?>:<?=$row->id_item;?>');"><button class="btn btn-mini"><i class="icon-shopping-cart"></i></button></a></td>
											</tr>
										</form>
										<?php
										}
