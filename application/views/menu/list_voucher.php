...
<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b>List Of Voucher</b></div>
                            </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                      ...
                                      ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                  <button class="btn btn-success btn-mini" title="Detail Company" onclick="detail_company(<?php echo $row->id_detail;?>);"><i class="icon-folder-open"></i></button>
                                                  <button class="btn btn-warning btn-mini" title="Update Company" onclick="update_company(<?php echo $row->id_detail;?>);"><i class="icon-edit"></i></button>
                                                  <button class="btn btn-danger btn-mini" title="Delete Company" onclick="delete_company(<?php echo $row->id_detail;?>);"><i class="icon-remove"></i></button>
                                                </td>
                                            </tr>
                    <?php
                    }
