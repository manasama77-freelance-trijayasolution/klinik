	...
	?>
		<div class="alert alert-success">
			...
			<strong>Success!</strong> Save Invoice
		</div>
	<?php
		} else if ($id=="update") {
	?>
		<div class="alert alert-success">
			<button class="close" data-dismiss="alert">&times;</button>
			<strong>Success!</strong> Update Invoice
		</div>
	<?php
		} else if ($id=="del") {
	?>
		<div class="alert alert-success">
			<button class="close" data-dismiss="alert">&times;</button>
			<strong>Success!</strong> Reset Invoice
		</div>
	<?php
		}
	?>		
	<script>
	  ...
	  function popup(b_id){
		window.open("<?php echo base_url();?>cashier/list_billing2","Popup","width=1200px, height=500px, top=70, left=80");
      }
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Item Request Form</b></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">           
                                    <fieldset>
                                      
										<form class="form-horizontal" action="<?php echo base_url();?>cashier/invoice_process" method="post" name="mark_mcu">
