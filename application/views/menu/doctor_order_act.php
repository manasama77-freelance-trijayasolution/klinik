		...
		<script>
			$(function() {
				window.onload = $.jGrowl("<b>Last Order Examination</b> : </br> <?php $aa = 1;
																				foreach ($last_order->result() as $row_last) {
																					echo "" . $aa++ . ". " . $row_last->serv_name . ", <span style='font-size: 85%'> " . time_elapsed_string1($row_last->order_date) . "</span></br>";
																				} ?>", {
					sticky: true
				});
			});
							...
							<form class="form-horizontal" action="<?php echo base_url(); ?>docter/save_order_lab" method="post" name="mst_pr">
								...
								<div class="control-group">
									...
									<div class="controls">
										...
										<input class="input-xlarge focused" name="client_name" type="hidden" id="myText03" value="<?= $_POST['client_name']; ?>" maxlength="0" autocomplete="off">
									</div>
								</div>
 ...
 -->
									...
									<div class="block">
										<div class="navbar navbar-inner block-header">
											<ul class="nav nav-tabs">
												<li class="active">
													<a href="#6" onMouseOut="this.style.textDecoration=''" onMouseOver="this.style.textDecoration='underline'" data-toggle="tab" style="border-radius: 15px; margin:5px;"><b>Odontogram</b></a>
												</li>
												<!-- 
    <li>
    ...
    -->
													...
													<div class="block-content collapse in" style="overflow-x: hidden;overflow-y: auto;padding-bottom: 50px;">
														<script language="javascript">
															function addRow_lab(tableID) {
																...
																cell3.innerHTML = "<input type='text' placeholder='start typing here. . .' onclick='if(this.value!=\"\") this.value=\"\";' onblur='javascript:if(this.value==\"\"){this.value=this.value;}' style='width: 550px;font-style: oblique;' class='span6' id='typeahead' name='lab_" + cell2.innerHTML + "' data-provide='typeahead' data-items='8' data-source='[<?php foreach ($lab_item->result() as $row) {
																																																																																																								echo '\"' . $row->order_id . ":" . $row->id_service . ":[ITEM] " . $row->serv_name . '\",';
																																																																																																							} ?> \"\"]\' autocomplete='off'><input type='hidden' name='rowC' value='" + cell2.innerHTML + "'>";
															}
														...
														<table class="table table-striped table-bordered" id="example4">
															<thead>
																<tr>
																	<th>No</th>
																	<th>Lab Services xxx</th>
																</tr>
															</thead>
															<tbody>
																<tr class="odd gradeX" id="voucher_">
																	<TD>1</TD>
																	<TD><input type="text" placeholder="start typing here. . ." onclick="if(this.value!='') this.value='';" onblur="javascript: if(this.value==''){this.value=this.value;}" style="width: 550px;font-style: oblique;" class="span6" id="typeahead" name="lab_1" data-provide="typeahead" data-items="8" data-source='[<?php foreach ($lab_item->result() as $row) {
																																																																																															echo '"' . $row->order_id . ":" . $row->id_service . ":[ITEM] " . $row->serv_name . '",';
																																																																																														} ?>""]' autocomplete="off"></TD>
													...
													<div class="block-content collapse in" style=" overflow-x: hidden;overflow-y: auto;padding-bottom: 50px;">
														<script language="javascript">
															function addRow(tableID) {
																...
																var cell3 = row.insertCell(1);
																cell3.innerHTML = "<input type='text' placeholder='start typing here. . .' onclick='if(this.value!=\"\") this.value=\"\";' onblur='javascript:if(this.value==\"\"){this.value=this.value;}' style='width: 550px;font-style: oblique;' class='span6' id='typeahead' name='rad_" + cell2.innerHTML + "' data-provide='typeahead' data-items='8' data-source='[<?php foreach ($rad_item->result() as $row) {
																																																																																																								echo '\"' . $row->order_id . ":" . $row->id_service . ":[ITEM] " . $row->serv_name . '\",';
																																																																																																							} ?> \"\"]\' autocomplete='off'><input type='hidden' name='rowC_rad' value='" + cell2.innerHTML + "'>";
															}
														...
														<table class="table table-striped table-bordered" id="example5">
															...
															<tbody>
																<tr class="odd gradeX" id="voucher_">
																	<TD>1</TD>
																	<TD><input type="text" placeholder="start typing here. . ." onclick="if(this.value!='') this.value='';" onblur="javascript: if(this.value==''){this.value=this.value;}" style="width: 550px;font-style: oblique;" class="span6" id="typeahead" name="rad_1" data-provide="typeahead" data-items="8" data-source='[<?php foreach ($rad_item->result() as $row) {
																																																																																															echo '"' . $row->order_id . ":" . $row->id_service . ":[ITEM] " . $row->serv_name . '",';
																																																																																														} ?>""]' autocomplete="off"></TD>
												...
												<div class="tab-pane" id="3">
													...
													<script language="javascript">
														function addRowPhar(tableID) {
															...
															if (gembok == "no") {
																var loop = "<option value=" + resep + ">" + resep + "</option><?php $b = 0;
																																while ($b <=  10) {
																																	if ($b == 0) {
																																		echo '<option value=' . $b . '>' . $b . '</option>';
																																		$b++;
																			...
																			<table style='border-radius:10px; overflow:hidden; border: 0px solid #282929;'>
																				<tr>
																					...
																					<td><input class='tgl tgl-ios' id='cbx_1' onmouseover="showDiv2(1)" onclick="manufacture(1)" type='checkbox' name='opsi_1' style='display:none;'>
																						<label class='tgl-btn' for='cbx_1'></label>
																					</td>
						...
						-->
													...
													<div class="block-content collapse in" style=" overflow-x: hidden;overflow-y: auto;padding-bottom: 50px;">
														<script language="javascript">
															function addRows(tableID) {
																...
																var cell3 = row.insertCell(1);
																cell3.innerHTML = "<input type='text' placeholder='start typing here. . .' onclick='if(this.value!=\"\") this.value=\"\";' onblur='javascript:if(this.value==\"\"){this.value=this.value;}' style='width: 650px;font-style: oblique;' class='span6' id='typeahead' name='ser_" + cell2.innerHTML + "' data-provide='typeahead' data-items='8' data-source='[<?php foreach ($others->result() as $row) {
																																																																																																								echo '\"' . $row->id_service . ":" . $row->id_group_serv . ":[GROUP] " . $row->group_desc . ":[ITEM] " . $row->serv_name . '\",';
																																																																																																							} ?> \"\"]\' autocomplete='off'><input type='hidden' name='rowC_ser' value='" + cell2.innerHTML + "'> <input type='hidden' name='qty_" + cell2.innerHTML + "' value='1' style='width: 90px;' onclick='if(this.value!=\"\") this.value=\"\";' onblur='javascript:if(this.value==\"\"){this.value=\"1\";}'>";
															}
														...
														<table class="table table-striped table-bordered" id="example7">
															...
															<tbody>
																<tr class="odd gradeX" id="voucher_">
																	<TD>1</TD>
																	<TD><input type="text" placeholder="start typing here. . ." onclick="if(this.value!='') this.value='';" onblur="javascript: if(this.value==''){this.value=this.value;}" style="width: 650px;font-style: oblique;" class="span6" id="typeahead" name="ser_1" data-provide="typeahead" data-items="20" data-source='[<?php foreach ($others->result() as $row) {
																																																																																															echo '"' . $row->id_service . ":" . $row->id_group_serv . ":[GROUP] " . $row->group_desc . ":[ITEM] " . $row->serv_name . '",';
																																																																																														} ?>""]' autocomplete="off"></TD>
													...
													<div class="block-content collapse in" style=" overflow-x: hidden;overflow-y: auto;padding-bottom: 50px;">
														<script language="javascript">
															function addRows_mcu(tableID) {
																...
																var cell3 = row.insertCell(1);
																cell3.innerHTML = "<input type='text' placeholder='start typing here. . .' onclick='if(this.value!=\"\") this.value=\"\";' onblur='javascript:if(this.value==\"\"){this.value=this.value;}' style='width: 450px;font-style: oblique;' class='span6' id='typeahead' name='mcu_" + cell2.innerHTML + "' data-provide='typeahead' data-items='8' data-source='[<?php foreach ($mcu->result() as $row) {
																																																																																																								echo '\"' . $row->id_quot . ":[ITEM] " . $row->quot_name . ' [' . $row->client_name . '] [' . $row->qout_id . '-' . $row->quot_revision . '] \",';
																																																																																																							} ?> \"\"]\' autocomplete='off'><input type='hidden' name='rowC_mcu' value='" + cell2.innerHTML + "'>";
															}
														...
														<table class="table table-striped table-bordered" id="example8">
															...
															<tbody>
																<tr class="odd gradeX" id="voucher_">
																	<TD>1</TD>
																	<TD><input type="text" placeholder="start typing here. . ." onclick="if(this.value!='') this.value='';" onblur="javascript: if(this.value==''){this.value=this.value;}" style="width: 450px;font-style: oblique;" class="span6" id="typeahead" name="mcu_1" data-provide="typeahead" data-items="8" data-source='[<?php foreach ($mcu->result() as $row) {
																																																																																															echo '"' . $row->id_quot . ":[ITEM] " . $row->quot_name . ' [' . $row->client_name . '] [' . $row->qout_id . '-' . $row->quot_revision . ']",';
																																																																																														} ?>""]' autocomplete="off"></TD>
												...
												<div class="tab-pane active" id="6">
													...
													<div class="block-content collapse in" style=" overflow-x: hidden;overflow-y: auto;padding-bottom: 50px;">
														...
														<!-- <img src="<?php echo base_url(); ?>design/images/odontogram.jpeg" height="200" width="500"></img> -->
														<br>

														<table border='0'>
															<tr>
																<td colspan='16'><img src='<?php echo base_url(); ?>design/images/odontogram/odon.jpg'></td>
																<!--<td colspan='16' rowspan='19'><img src='asli.jpg' ></td>-->
															</tr>
															<tr>
																<td>18</td>
																<td>17</td>
															...
															<tr>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="18"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="17"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="16"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="15"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="14"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="13"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="12"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="11"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="21"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="22"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="23"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="24"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="25"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="26"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="27"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="28"></td>
																<td><img src='<?php echo base_url(); ?>design/images/odontogram/separator.jpg'></td>
															...
															<tr>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/separator2.jpg); background-repeat:no-repeat;"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/separator2.jpg); background-repeat:no-repeat;"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/separator2.jpg); background-repeat:no-repeat;"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="55"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="54"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="53"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="52"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="51"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="61"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="62"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="63"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="64"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="65"></td>
																<td></td>
																<td></td>
																<td></td>
																<td><img src='<?php echo base_url(); ?>design/images/odontogram/separator2.jpg'></td>
															</tr>
															<tr>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/separator2.jpg); background-repeat:no-repeat;"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/separator2.jpg); background-repeat:no-repeat;"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/separator2.jpg); background-repeat:no-repeat;"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="85"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="84"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="83"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="82"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="81"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="71"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="72"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="73"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="74"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/small.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="75"></td>
																<td></td>
																<td></td>
																<td></td>
																<td><img src='<?php echo base_url(); ?>design/images/odontogram/separator2.jpg'></td>
															...
															<tr>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="48"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="47"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="46"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="45"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="44"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="43"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="42"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="41"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="31"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="32"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="33"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="34"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="35"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="36"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="37"></td>
																<td style="background-image:url(<?php echo base_url(); ?>design/images/odontogram/single.jpg); background-repeat:no-repeat;"><input type='checkbox' name='satu[]' value="38"></td>
																<td><img src='<?php echo base_url(); ?>design/images/odontogram/separator.jpg'></td>
															</tr>
														...
														<!--
		Create Date : <b><?php if ($soap->num_rows() > 0) {
								echo $show->create_date;
							} ?></b></br>
        Create By	: <b><?php if ($soap->num_rows() > 0) {
								echo $show->fullname;
							} ?></b></br>
		Last Update : <b><?php if ($soap->num_rows() > 0) {
								echo time_elapsed_string_doctor($show->update_date);
							} ?></b>
		<hr>
		<div class="control-group">
           <label class="control-label" for="textarea2"><b>S</b>ubject</label>
           <div class="controls">
             <textarea id="ss" class="input-xlarge textarea" <?php if ($soap->num_rows() > 0) {
																	echo "readonly";
																} ?> name="s" placeholder="Enter text ..." style="width: 410px; height: 100px"><?php if ($soap->num_rows() > 0) {
																																					echo $show->Subject;
																																				} ?></textarea> <input name="s1" onclick="sel_s()" type="checkbox">
           </div>
        </div>
		...
		<div class="control-group">
           ...
           <div class="controls">
             <textarea id="oo" class="input-xlarge textarea" name="o" <?php if ($soap->num_rows() > 0) {
																			echo "readonly";
																		} ?> placeholder="Enter text ..." style="width: 410px; height: 100px"><?php if ($soap->num_rows() > 0) {
																																					echo $show->Object;
																																				} ?></textarea> <input name="o1" onclick="sel_o()" type="checkbox">
           </div>
        </div>
		...
		<div class="control-group">
           ...
           <div class="controls">
             <textarea id="aa" class="input-xlarge textarea" name="a" <?php if ($soap->num_rows() > 0) {
																			echo "readonly";
																		} ?> placeholder="Enter text ..." style="width: 410px; height: 100px"><?php if ($soap->num_rows() > 0) {
																																					echo $show->Assessment;
																																				} ?></textarea> <input name="a1" onclick="sel_a()" type="checkbox">
           </div>
        </div>
		...
		<div class="control-group">
           ...
           <div class="controls">
             <textarea id="pp" class="input-xlarge textarea" name="p" <?php if ($soap->num_rows() > 0) {
																			echo "readonly";
																		} ?> placeholder="Enter text ..." style="width: 410px; height: 100px"><?php if ($soap->num_rows() > 0) {
																																					echo $show->Plan;
																																				} ?></textarea> <input name="p1" onclick="sel_p()" type="checkbox">
           </div>
        </div>	
		-->
													</div>
													...
													<div class="block-content collapse in" style="overflow-x: hidden;overflow-y: auto;padding-bottom: 50px;">
														<script language="javascript">
															function addRow_gi(tableID) {
																...
																var cell3 = row.insertCell(1);
																cell3.innerHTML = "<input type='text' placeholder='start typing here. . .' onclick='if(this.value!=\"\") this.value=\"\";' onblur='javascript:if(this.value==\"\"){this.value=this.value;}' style='width: 1050px;font-style: oblique;' class='span6' id='typeahead' name='grp_" + cell2.innerHTML + "' data-provide='typeahead' data-items='8' data-source='[<?php foreach ($group_item->result() as $row) {
																																																																																																									echo '\"' . $nol . ":" . $row->id . ":[ITEM] " . $row->name_service . '\",';
																																																																																																								} ?> \"\"]\' autocomplete='off'><input type='hidden' name='rowC_grp' value='" + cell2.innerHTML + "'>";
															}
														...
														<table class="table table-striped table-bordered" id="example99">
															...
															<tbody>
																<tr class="odd gradeX" id="voucher_">
																	<TD>1</TD>
																	<TD><input type="text" placeholder="start typing here. . ." onclick="if(this.value!='') this.value='';" onblur="javascript: if(this.value==''){this.value=this.value;}" style="width: 1050px;font-style: oblique;" class="span6" id="typeahead" name="grp_1" data-provide="typeahead" data-items="8" data-source='[<?php foreach ($group_item->result() as $row) {
																																																																																															echo '"' . $nol . ":" . $row->id . ":[ITEM] " . $row->name_service . '",';
																																																																																														} ?>""]' autocomplete="off"></TD>
