	...
	<script language="javascript">
        function addRow(tableID) {
			...
			cell4.innerHTML = "<div align='right'><input class='input-xlarge-i' id='total["+cell2.innerHTML+"]' onchange='setBlurFocus("+cell2.innerHTML+");' name='price["+cell2.innerHTML+"]' autocomplete='off' placeholder='0' style='width:145px; text-align:right;' type='text'><input type='hidden' name='rowcount' value='"+cell2.innerHTML+"'><input type='hidden' name='seq["+cell2.innerHTML+"]'><input type='hidden' name='id["+cell2.innerHTML+"]'><input type='hidden' name='fulus["+cell2.innerHTML+"]' id='fulus["+cell2.innerHTML+"]'><input type='hidden' name='orderid["+cell2.innerHTML+"]' id='orderid["+cell2.innerHTML+"]'><input type='hidden' name='id_service["+cell2.innerHTML+"]' id='id_service["+cell2.innerHTML+"]'><input type='hidden' name='orderty["+cell2.innerHTML+"]' id='orderty["+cell2.innerHTML+"]'><input type='hidden' name='group["+cell2.innerHTML+"]' id='group["+cell2.innerHTML+"]'></div>";
        }
				...
				<body onload="startTime()">
                    ...
                    <div class="row-fluid" onmouseover="loadgrandtotal('example2'); loadgrandtotal4();">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Master Service Package</b></div>
							...
							<div class="btn-group">
							 ...
							 <ul class="dropdown-menu">
								<li><a href="<?php echo base_url();?>marketing/list_package"><i class="icon-th-large"></i> List Master Package</a></li>
                                      ...
                                      <fieldset>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            ...
                                            <input class="input-small" name="qty" id="qty" onkeyup="loadgrandtotal4();" type="number" autocomplete="off" disabled required> <i class="icon-user"></i> <b>Pax</b>
                                          </div>
                                        </div>
										...
										<table class="table table-striped table-bordered" id="example2">
											...
											<tr class="odd gradeX" id="voucher_">
												<td>1</td>
												<td><input type="text" name="service[1]" style="width:585px" placeholder="service item" id="a1" required/> <button id="pop1" type="button" onclick="popup(1); loadgrandtotal('example2');" class="btn btn-success btn-mini"><i class="icon-search"></i></button></td>
												
												<td>
												<div align="right">
												<input id="total[1]"  name="price[1]" placeholder="0" style="width:145px; text-align:right" onchange="setBlurFocus(1);" autocomplete="off" type="text">

												<input name="rowcount" id="rowcount" type="hidden" value="1">
												<input name="seq[1]" type="hidden"/> 
												<input name="id[1]" id="id[1]" type="hidden">
												<input name="id_service[1]" id="id_service[1]" type="hidden">
												<input name="fulus[1]" id="fulus[1]" type="hidden">
												<input name="orderid[1]" id="orderid[1]" type="hidden">
												<input name="orderty[1]" id="orderty[1]" type="hidden">
												<input name="group[1]" id="group[1]" type="hidden">
												</div>
												</td>
											</tr>
											</tbody>
										...
										<table class="table table-striped table-bordered">
											...
											<tr class="odd gradeX">
												<td><div align="right"><b>Margin</b> <input class="input-xlarge-in focused" id="adjs" name="adjs_amount" value="0" style="width:45px; text-align:right" autocomplete="off" max="100" type="number" onclick="margins();" onkeyup="margins();"> <b>%</b> <input class="input-xlarge-in focused" autocomplete="off"  id="adjs_amt" name="adjs_nominal" value="0" onkeyup="loadgrandtotal2('example2');" style="width:145px; text-align:right" type="text" readonly><input id="grandma" type="hidden"></div></td>
											</tr>
											<tr class="odd gradeX">
