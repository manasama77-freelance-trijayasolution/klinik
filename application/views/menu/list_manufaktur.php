				...
				function myFunction_3(id) {
					var myWindow = window.open("<?php echo base_url();?>Pharmacy/list_detail_manufaktur/"+id+"", "", "width=1000px, height=600px");
				}
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
							 ...
							 <div class="btn-group">
							  <a href="<?php echo base_url();?>Pharmacy/add_manufaktur"><button class="btn btn-success"><i class="icon-plus icon-white"></i> Add New</button></a>
							 </div>
							 </div>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
										...
										?>
                                            <tr class="odd gradeX">
												...
												<button class="btn btn-info btn-mini" title="Detail Manufacture" onclick="myFunction_3('<?php echo $row->id_manufaktur;?>');"><i class="icon-folder-open"></i></button> 
												<!-- <button class="btn btn-warning btn-mini" title="Update Manufacture" onclick="myFunction_2('<?php echo $row->id_manufaktur;?>');"><i class="icon-edit"></i></button>  -->
												<button class="btn btn-danger btn-mini" title="Delete Manufacture" onclick="myFunction('<?php echo $row->id_manufaktur;?>');"><i class="icon-trash"></i></button></td>	
                                            </tr>
										<?php
										}
										?>
