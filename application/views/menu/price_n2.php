		...
		document.getElementById(id+'b').value = user_input;
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Master Radiologi Item Price</b></div>
                            </div>
                                ...
                                <div class="span12">           
									...
									<form class="form-horizontal" action="<?php echo base_url();?>smart/save_item_lab" method="post" name="mst_service">
                                        <div class="control-group">
                                          ...
                                          <input type="text" name="grp_services" value="Pemeriksaan Radiologi" readonly/>
                                          </div>
										</div>
										<div class="control-group">
                                          <label class="control-label" for="focusedInput">Services Name</label>
                                          <div class="controls">
                                          <input type="text" name="serv_name"  value="<?=$rad_item;?>" readonly/>
