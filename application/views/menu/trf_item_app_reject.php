...
?>
                    ...
                    <div class="row-fluid notification" id="notification-sticky">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Reject Transfer Items</b></div>
                            <div class="muted pull-right" id="txt" style="font-weight: bold;"></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">           
                                	<form class="form-horizontal" name="uguu" id="uguu" onsubmit="return confirm('Do you really want to submit the form?');" method="post" action="<?php echo base_url();?>inv/save_trf_item_reject" >
                                    <fieldset>
					...
					<div class="controls">
					<textarea style="width: 810px; height: 200px;" placeholder="REASON"></textarea>
					</div>
