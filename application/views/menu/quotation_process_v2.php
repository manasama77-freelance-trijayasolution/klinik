  ...
  -webkit-transform: rotateY(20deg);
    ...
    function addRow(tableID) {
		...
		function margins(){
			...
			var margin 		= sell * qty / 100;
			peka.value		= accounting.formatMoney(parseInt(sell) + parseInt(margin));
	...
	?>
				<body onload="startTime();loadgrandtotal('example2'); loadgrandtotal4();">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in" >         
                                      <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>marketing/save_qoutation_v2" method="post" name="quotation">
										...
										<!--    <input type="text" value="<?=$hasilnya;?>" name="20" style="width: 35px;" readonly> - 
										  ...
										  <input type="hidden" name="id_marketing" value="<?=$id_marketing;?>">
                                          </div>
                                        </div>
										...
										?>												
											<tr>
												...
												<tr>
													...
													<option value='Administration system' align='justify'>Administration</option>
												...
												<tr>
													...
													<input name="id_service[<?=$no;?>]" id="id_service[<?=$no;?>]" type="hidden" value="<?=$row->id_service?>">
										...
										<table class="table table-hover" style="border-radius:10px;">
											...
											<td><div align="right"><table style='border-radius:10px; overflow:hidden; border: 0px solid #282929;'>
												<tr>
												<td><b>Margin</b> <input class="input-xlarge-in focused" id="adjs" name="adjs_amount" value="0" style="width:45px; text-align:right" autocomplete="off" max="100" type="text" onkeyup="margins();"> <input class="input-xlarge-in focused" autocomplete="off"  id="adjs_amt" name="adjs_nominal" value="0"  style="width:145px; text-align:right"   type="text"><input id="grandma" type="hidden"></td>
												</tr>
												</table></div></td>
											</tr>
											<tr class="success">
