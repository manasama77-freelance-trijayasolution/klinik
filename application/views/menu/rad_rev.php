                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                    <fieldset>
									<form class="form-horizontal" action="<?php echo base_url();?>Radiology/update_rad_act/<?=$idx;?>" method="post" name="quesioner_mcu">
												...
												<div class="block-content collapse in">
													...
													<div id="" style="overflow-y: auto; height:auto;">
														<table class="table table-hover table-bordered" id="example3">
															...
															?>
															<tr class="odd gradeX">
																<input type="hidden" name="id_rad_result[]" value="<?php echo $id_rad_result[$nomor];?>">
																...
																?>
															<td><input type="text" style="display: none;" name="nama_value[<?=$name_rad++;?>]" value="<?php echo $row->rad_item;?>"><?php echo $row->rad_item;?><hr><input type="text" name="dr_<?=$dr++;?>" value="<?php echo $doctor_exam[$nomor];?>" required></td>
															...
															Last Result : <?php echo $result[$nomor];?>
															</div>
															</div>
															</br>
															<!--
