                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                      <fieldset>
										...
										<form class="form-horizontal" action="<?php echo base_url();?>inv/save_conversion" method="post" name="mst_service">
                                      ...
                                      <div class="btn-group pull-right">
                                        <!--  <button data-toggle="dropdown" class="btn dropdown-toggle"><i class="icon-file"></i> Export Data <span class="caret"></span></button>
                                         <ul class="dropdown-menu">
                                          ...
                                          <ul class="dropdown-menu">
											<li><a href="<?php echo base_url();?>inv/inv_conversion_excel"><i class="icon-list-alt"></i> Export to Excel</a></li>
                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
										...
										?>
											<tr class="odd gradeX">
												...
												<td>
													<button onclick="edit_conversion(<?php echo $row->id_conv;?>);" class="btn btn-warning btn-mini"><i class="icon-edit"></i></button>
													<button onclick="delete_conversion(<?php echo $row->id_conv;?>);" class="btn btn-danger btn-mini"><i class="icon-trash"></i></button>
												</td>											
											</tr>
										</form>
										<?php
