		...
		window.open("<?php echo base_url();?>inv/mst_item_price","Popup","height=610, width=980, top=50, left=210 ");
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Request New Item</b></div>
                            </div>	
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
										<form class="form-horizontal" action="<?php echo base_url();?>inv/save_request_item" method="post" id="form_sample_1" name="mst_service">
