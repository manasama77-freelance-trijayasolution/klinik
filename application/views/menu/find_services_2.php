				...
				<script type="text/javascript">
					...
					window.opener.document.forms['mst_service'].elements['serv_typ'].value=myarr[2];
					window.close(this);
					}
				</script>
                <div class="row-fluid">
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										?>
											<tr class="odd gradeX">
												...
												<td><a href="" onclick="closeit('<?=$row->serv_name;?>:<?=$row->id_service;?>:<?=$row->id_serv_group;?>');"><button class="btn btn-success btn-mini"><i class="icon-tags"></i></button></a></td>
											</tr>
										</form>
										<?php
										}
