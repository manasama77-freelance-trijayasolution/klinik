				...
				<script type="text/javascript">
					...
					window.opener.document.forms['quotation'].elements['notes_services_<?=$id;?>'].value=myarr[8];
					window.close(this);
					}
				</script>
                <div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">                                   
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										<font color=red>* Apabila ada tindakan yang tidak ada, hubungi bagian Finance untuk input harga <b>HPP</b></font>
									</table>
                                </div>
                            </div>
                        </div>
