...
.tgl-flip:checked + .tgl-btn:active:after {
  -webkit-transform: rotateY(20deg);
	...
	<body onload="startTime()">
                    ...
                    <div class="row-fluid">
                        <!-- block --> 
                    <form action="<?php echo base_url();?>master/save_notes" method="post" id="quotation">
					         <div class="row-fluid">
                        <!-- block -->
                   

                    <input type="hidden" id="group_notes" name="group_notes" value="<?=$group_notes?>">
                    <input type="hidden" id="id_order" name="id_order" value="<?=$id_order?>">
                    <input type="hidden" id="id_reg" name="id_reg" value="<?=$id_reg?>">
                    <input type="hidden" id="id_pat" name="id_pat" value="<?=$id_pat?>">
                    ...
                    <?php
                    if ($group_notes == 1) {
                      echo "<h1>Cancel Lab Order </h1>";
                    }elseif ($group_notes == 2) {
                      echo "<h1>Cancel Radiologi Order ".$kodenya." </h1>";
                    }elseif ($group_notes == 3) {
                      echo "<h1>Reject Purchase Request ".$kodenya." </h1>";
                    ...
                    ?>
                        ...
                        <div class="controls">
                         <textarea name="notes" id="ckeditor_full"></textarea>
                        </div>
                ...
                <!-- <button class="btn btn-danger btn-large" type="reset"><b>Reset</b></button> -->
                <!-- <button onClick="window.location.reload()" class="btn btn-danger btn-large"><b>Reset</b></button> -->
                </div>
                </div>
