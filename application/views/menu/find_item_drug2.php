				...
				<script type="text/javascript">
					...
					window.opener.document.forms['mst_pr'].elements['id_item[<?=$link;?>]'].value=myarr[0];
					window.opener.document.forms['mst_pr'].elements['item[<?=$link;?>]'].value=myarr[1];
					window.opener.document.forms['mst_pr'].elements['unit[<?=$link;?>]'].value=myarr[2];
					// window.opener.document.forms['mst_pr'].elements['unitx[<?=$link;?>]'].value=myarr[2];
					window.opener.document.forms['mst_pr'].elements['id_base[<?=$link;?>]'].value=myarr[3];
					window.close(this);
						}
				</script>
				<?php
