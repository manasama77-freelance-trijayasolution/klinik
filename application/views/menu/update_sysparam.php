                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
								<div class="muted pull-left"><b>Update Parameter <?=$isi;?> </b></div>
                            </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                      <fieldset>
										...
										<form class="form-horizontal" action="<?php echo base_url();?>master/update_sysparam_process" method="post" name="quotation">		
									
										
										<input class="input-xlarge focused" name="sgroup" type="hidden" id="1" value="<?=$isi;?>" readonly>
										<input class="input-xlarge focused" name="id_param" type="hidden" id="2" value="<?=$id_param;?>" readonly>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="skey" value="<?=$skey;?>" type="text" id="3" disabled autocomplete="off" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="svalue" value="<?=$svalue;?>" type="text" id="4" disabled autocomplete="off" required>
                                          </div>
                                        </div>																				
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="lvalue" value="<?=$lvalue;?>" type="text" id="5" disabled autocomplete="off" required>
                                          </div>
                                        </div>																				
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea name="remark" id="6" disabled autocomplete="off" required><?=$remark;?></textarea>
                                          </div>
                                        </div>
										</div>
