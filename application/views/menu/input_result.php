	<?php
		...
		$logic 					="update pat_mcu_result set locked=0,lock_by=$user_id where id_regist='".$reg."'";  
		//echo $logic;
	...
	?>
		<div class="alert alert-success">
			...
			<strong>Success!</strong> Input Result <b>(Doctor)</b> Medical Check Up [<?=$reg?>]
		</div>
	<?php
		} else if ($id=="update") {
	?>
		<div class="alert alert-success">
			<button class="close" data-dismiss="alert">&times;</button>
			<strong>Success!</strong> Update Result <b>(Doctor)</b> Medical Check Up [<?=$reg?>]
	    </div>
	<?php
		} else if ($id=="del") {
	?>
	...
	?>
		<div class="alert alert-success">
			<button class="close" data-dismiss="alert">&times;</button>
			<strong>Success!</strong> Unlock Input MCU for ID : <b><?=$reg;?></b>
		</div>
	<?php
		}
	?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                    <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>patient/input_result_act" method="post" name="mark_mcu">
										
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">ID Registration</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="pat_mrn" type="text" maxlength="0" autocomplete="off" placeholder=" ... " required>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											<input class="input-xlarge focused" name="pat_mcu" type="text" id="" readonly autocomplete="off" > 	
                                          </div>
                                        </div>
									</fieldset>     
                                </div>
