    ...
    <script>
      ...
      function popup(id){
        ...
        window.open("<?php echo base_url();?>marketing/find_services_q/"+id+"/"+idx+"","Popup","height=550, width=980, top=70, left=180 ");
                ...
                <body onload="startTime()">
                    ...
                    <div class="row-fluid" onmouseover="loadgrandtotal('example2');">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>New Counter</b></div>
                            ...
                            <div class="btn-group">
                             ...
                             <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url();?>marketing/list_quotation"><i class="icon-th-large"></i> My Counter</a></li>
                                <?php if ($userlvl != "user"){?>
                                <li><a href="<?php echo base_url();?>marketing/list_quotation_app"><i class="icon-th-large"></i> My Counter Staff</a></li>
                                <?php }?>
                            ...
                            <div class="block-content collapse in" style="display:none;" id="locked">         
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Date Counter</label>
                                          <div class="controls">
                                        ...
                                        <table class="table table-hover" id="example2">
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                    <INPUT id="total[1]" name="price[1]" value="0" style="width:145px; text-align:right" onmouseover="loadgrandtotal('example2');" type="text" onchange="setBlurFocus(1);">
                                                    </br>
                                        ...
                                        <div id="myAlert" class="modal hide">
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" class="btn btn-success" onclick="this.disabled=true;this.form.submit();" id="save" value="Save" disabled>
