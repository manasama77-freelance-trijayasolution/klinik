...
<div class="row-fluid">
	<div class="block">
		<div class="navbar navbar-inner block-header">
			<div class="muted pull-left"><b>Report Profit</b></div>
		</div>
		<div class="block-content collapse in">
			<div class="span12">
				<form class="form-horizontal" action="<?php echo base_url(); ?>cashier/report_profit_excel" method="post" name="mst_pr">
...
<script>
	function generatePDF() {
		...
		if (datereg1.length == 0) {
			...
			window.open(`<?= site_url('cashier/report_profit_pdf'); ?>/${datereg1}/${datereg2}`, '_blank');
		}
	}
</script>