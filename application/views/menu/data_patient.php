                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                      <fieldset>
										...
										<div class="control-group">
                                          <label class="control-label" for="focusedInput"> <b>Religion</b> <font color="red">*</font> </label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" style="text-transform: uppercase;" name="religion" type="text" id="10" disabled autocomplete="off" required> 
                                          </div>
                                        </div>

										<div class="control-group">
                                          <label class="control-label" for="focusedInput"> <b>Job</b> <font color="red">*</font> </label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" style="text-transform: uppercase;" name="jobs" type="text" id="23" disabled autocomplete="off" required> 
                                          </div>
                                        </div>
													<!-- 																															
										<div class="control-group">
										 ...
										 -->
										<div class="control-group">
                                          <label class="control-label" for="focusedInput"> <b>Mobile Phone</b> <font color="red">*</font> </label>
                                          <div class="controls">
										  <input type="text" name="pat_contact_misc[1]" maxlength="4" id="19" style="width:45px" placeholder="08XX" disabled> - <input type="text" name="pat_contact_misc[2]" style="width:45px" maxlength="4" id="13" placeholder="XXXX" required disabled> - <input type="text" name="pat_contact_misc[3]" style="width:45px" maxlength="4" id="14" placeholder="XXXX" required disabled>
                                          </div>
                                        </div>
