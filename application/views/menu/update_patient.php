                                      ...
                                      <fieldset>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" style="text-transform: uppercase;" name="pat_name" type="text" id="3" disabled autocomplete="off" required value="<?=$row_pat->pat_name?>"> - <select name="pat_title" id="4" style="width:80px"  disabled >
											  ...
											  ?>
												<option value="<?=$rows->id_title?>" <?php if($rows->id_title==$row_pat->id_title){ echo "selected";} ?> align="justify"><?=$rows->title_desc?>.</option>
											  <?php
											  }
											  ?>
											</select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="pat_gender" id="5" disabled required>
											  ...
											  ?>
												<option value="<?=$rows->id_gender?>" <?php if($rows->id_gender==$row_pat->pat_gender){ echo "selected";} ?> align="justify"><?=$rows->gender?></option>
											  <?php
											  }
											  ?>
                                            </select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="pat_marital_status" id="7" disabled>
											  ...
											  ?>
												<option value="<?=$rows->id_status?>" <?php if($rows->id_status==$row_pat->pat_marital_status){ echo "selected";}?> align="justify"><?=$rows->marital_status?></option>
											  <?php
											  }
											  ?>
                                            </select>                                        
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select id="14" name="pat_nationality" style="width:285px" disabled>
											  ...
											  ?>
												<option value="<?=$rows->id_nationality?>" <?php if($rows->id_nationality==$row_pat->pat_nationality){ echo "selected";}?> align="justify"><?=$rows->nationality?></option>
											  <?php
											  }
											  ?>
                                            </select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select id="16" name="pat_province" onchange="fetch_select(this.value);"  disabled>
											  ...
											  ?>
												<option value="<?=$rows->provinsi_id?>" <?php if($rows->provinsi_id==$row_pat->pat_province){ echo "selected";}?> align="justify"><?=$rows->provinsi_nama;?></option>
											  <?php
											  }
											  ?>
                                            </select>
										...
										<div class="control-group">
                                          ...
                                          <?php
											    ...
											    ?>
												<option value="<?=$row['kota_id'];?>" <?php if($row['kota_id']==$row_pat->pat_city){ echo "selected";}?> align="justify"><?=$row['nama_kota'];?></option>
												<?php
											     }
												 ?>
												</select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select class="chzn-select" id="18" name="pat_rel_type" disabled>
											  ...
											  ?>
												<option value="<?=$rows->id_relative?>" <?php if($rows->id_relative==$row_pat->pat_rel_type){ echo "selected";}?>  align="justify"><?=$rows->relation?></option>
											  <?php
											  }
											  ?>
                                            </select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select id="21" name="id_client" disabled >
											  ...
											  ?>
												<option value="<?=$rows->id_Client?>" <?php if($rows->id_Client==$row_pat->id_client){ echo "selected";}?> align="justify"><?=$rows->client_name?></option>
											  <?php
											  }
											  ?>
                                            </select>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select id="23" name="id_client_dept" disabled >
											  ...
											  ?>
												<option value="<?=$rows->id_client_dept?>" <?php if($rows->id_client_dept==$row_pat->id_client_dept){ echo "selected";}?> align="justify"><?=$rows->client_dept?></option>
											  <?php
											  }
											  ?>
                                            </select>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select id="24" name="id_client_job" disabled >
											  ...
											  ?>
												<option value="<?=$rows->id_client_job?>" <?php if($rows->id_client_job==$row_pat->id_client_job){ echo "selected";}?>  align="justify"><?=$rows->client_job_desc?></option>
											  <?php
											  }
											  ?>
                                            </select>
