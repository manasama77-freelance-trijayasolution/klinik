		...
		function del_reg(id) {
			...
			<form class="form-horizontal" action="<?php echo base_url();?>regreport/reg_report" method="post" name="mst_service">
				<div class="control-group">
				  <label class="control-label" for="focusedInput">ID Reg</label>
				  <div class="controls">
				 <input class="input-medium focused" disabled name="id_reg1" type="text" id="1" autocomplete="off">	to		 
					<input class="input-medium focused" disabled name="id_reg2" type="text" id="2" autocomplete="off">
				  </div>
				</div>							
				<div class="control-group">
				  <label class="control-label" for="focusedInput">Date of Reg</label>
				  <div class="controls">
				   <input  class="input-medium datepicker"  readonly name="datereg1" type="text" id="datepicker" autocomplete="off" value="<?php echo date("m/d/Y");?>">
				   to		 
				   <input  class="input-medium datepicker"  readonly name="datereg2" type="text" id="datepicker1" autocomplete="off" value="<?php echo date("m/d/Y");?>">
				  </div>
				</div>
				<div class="form-actions">
				<button type="submit" name="act" disabled id="View" class="btn btn-success" value="View"><i class="icon-zoom-in"></i> <b>View</b></button>
				<button type="submit" name="act" disabled id="Print" class="btn btn-success" value="Print"><i class="icon-print"></i> <b>Print</b></button>
				</div>
				</form>
                                ...
                                <div class="span12">
  								...
  								<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
									...
									<?php } ?>
											...
											<td><?php echo $row->pat_name;?> <div style="float:right;"><button onclick="change_pat(<?php echo $row->pat_MRN;?>);" class="btn btn-info btn-mini"><i class="icon-edit"></i></button></div></td>
