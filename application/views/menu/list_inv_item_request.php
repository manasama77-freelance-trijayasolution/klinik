		      ...
		      function app_item(id){
		      	window.open("<?php echo base_url();?>inv/app_item_request/"+id+"","Popup","height=610, width=980, top=50, left=210 ");
		      }
										...
										?>
											<tr class="odd gradeX">
												...
												<td>
													...
													<button class="btn btn-success btn-mini" title="Approve Item" onclick="app_item(<?php echo $row->id_item;?>);"><i class="icon-ok"></i></button>
