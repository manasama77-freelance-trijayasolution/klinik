    ...
    function add_sysparam(group){
		window.open("<?php echo base_url();?>master/add_new_sysparam","Popup","height=610, width=980, top=50, left=210 ");
    }
								   ...
								   <div id="" style="overflow-y: auto; height:auto;">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										<tr class="odd gradeX">
											...
											<td>
													<button class="btn btn-info btn-mini" title="View <?=$row->sgroup;?>" onclick="cek_group('<?php echo $row->sgroup;?>');"><i class="icon-list"></i></button>
											</td>
										</tr>
										</form>
										<?php
