  ...
  src: url('<?php echo base_url();?>design/font/IDAutomationHC39M.ttf');
	...
	<head>
        <title>Marking Sheet Doctor Order | Print From IP : <?=$_SERVER['REMOTE_ADDR'];?></title>
				<p align="center"><b><u>Klinik drg. Magista Lutfia</u></b></br>				<font style="font-family: 'helvetica', helvetica, serif; font-size: 12px;"><b>Marking Sheet Doctor Order</b></font></br></p>
				<?php
				...
				<table class="altrowstable3" id="alternatecolor3" width="100%">
				  <thead>
					...
					?>
						...
						<td valign="top" colspan="5"><b>Outpatient</b></td>	</tr>
					</tr>
					<tr>
