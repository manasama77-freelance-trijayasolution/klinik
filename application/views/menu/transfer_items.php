                                   ...
                                   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
										...
										?>
                                           <tr class="odd gradeX">
												...
												<td><?php echo $row->jumlah;?> <font size="1px">/<?php echo $row->baseunit;?></font></td>	
												<td>
												<button class="btn btn-info btn-mini" title="Transfer Items" onclick="myFunction_2('<?php echo $row->id_item;?>');"><i class="icon-refresh"></i></button> 

												<button class="btn btn-info btn-mini" title="Warehouse" onclick="myFunction_3('<?php echo $row->id_item;?>');"><i class="icon-folder-open"></i></button></td>	
											</tr>
										<?php
										}
										?>
