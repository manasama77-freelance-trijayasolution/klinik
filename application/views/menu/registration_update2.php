                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<div id="" style="overflow-y: auto; height:auto;">
                                    <form action="<?php echo base_url();?>registration/reg_update_process2" method="post" class="form-horizontal" id="form_sample_1" name="quesioner_mcu">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select class="chzn-select" name="id_client_job" >
                                              <option value="0">- Choose Company Job -</option>
                                              <?php 

											  foreach($get_client_job->result() as $rows){
											  	if ($rows->id_client_job == $row_data->id_client_job) {
											  		$uia = "selected";
											  	}else{
                                              		$uia ="";
											  	}
											  ?>
												<option value="<?=$rows->id_client_job?>" align="justify" <?php echo $uia;?> ><?=$rows->client_job_desc?></option>
											  <?php
											  }
											  ?>
                                            </select>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select class="chzn-select" name="id_dr">
											  ...
											  ?>
												<option value="<?=$rows->id?>" <?php if ($row_data->id_dr == $rows->id){echo "selected";} ?> align="justify"><?=$rows->fullname?></option>
											  <?php
											  }
											  ?>
                                            </select>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select class="chzn-select" name="id_sal">
											  ...
											  <option value="001" <?php if ($row_data->id_sales == "001"){echo "selected";} ?>>Office (Website, Onsite)</option>
                                              <?php 
											  foreach($get_sales->result() as $rows){
											  ?>
												<option value="<?=$rows->id?>" <?php if ($row_data->id_sales == $rows->id){echo "selected";} ?>	align="justify">
												<?=$rows->fullname?>
												</option>
											  <?php
											  }
