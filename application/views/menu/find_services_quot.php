				...
				<script type="text/javascript">
					...
					window.opener.document.getElementById('service[<?=$id;?>]').value=myarr[0];
					window.opener.document.getElementById('total[<?=$id;?>]').value=myarr[1];
					window.opener.document.getElementById('id_service[<?=$id;?>]').value=myarr[2];
					window.opener.document.getElementById('seq[<?=$id;?>]').value=myarr[3];
					window.opener.document.getElementById('fulus[<?=$id;?>]').value=myarr[4];
					window.opener.document.getElementById('orderid[<?=$id;?>]').value=myarr[5];
					window.opener.document.getElementById('orderty[<?=$id;?>]').value=myarr[6];
					window.opener.document.getElementById('group[<?=$id;?>]').value=myarr[7];
					window.opener.document.getElementById('notes_services[<?=$id;?>]').value=myarr[8];
					window.close(this);
					}
				</script>
                <div class="row-fluid">
