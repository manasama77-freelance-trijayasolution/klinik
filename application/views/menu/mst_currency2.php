			...
			x = "You pressed Cancel!";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="muted pull-left"><b>Master Currency</b></div>
                            </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                      <fieldset>
										<form class="form-horizontal" action="<?php echo base_url();?>marketing/save_mst_currency" method="post" name="mst_service">
										<div class="control-group">
                                          <label class="control-label" for="focusedInput">Date</label>
                                          <div class="controls">
                                          	<input type="hidden" name="id_currency" value="<?=$id_currency;?>">
											<input type="text" name="tanggal" class="input-large datepicker" id="reg_date" value="<?=$tanggal;?>" readonly><readonly button class="btn-mini tooltip-right" data-original-title="Date of Registration adalah tanggal kunjungan pasien pada hari ini, namun bisa disesuaikan tanggalnya."><i class="icon-question-sign"></i></button>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
										  <input class="input-xlarge focused" name="nilai" type="text" id="1" autocomplete="off" disabled>
                                          </div>
                                        </div>
									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										?>
											<tr class="odd gradeX">
												...
												<td>
													<button onclick="update_currency(<?php echo $row->id_currency;?>);" class="btn btn-warning btn-mini" title="Update Currency"><i class="icon-edit"></i></button>
													<button class="btn btn-danger btn-mini" id="del<?php echo $row->id_currency;?>" onclick="delete_currency(<?php echo $row->id_currency;?>);"><i class="icon-trash"></i></button>
												</td>
											</tr>
										</form>
										<?php
