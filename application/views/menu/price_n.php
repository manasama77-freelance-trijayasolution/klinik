                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
									...
									<?php foreach ($get_items->result() as $row) {} ?>
									<form class="form-horizontal" action="<?php echo base_url();?>smart/save_mst_items_price" method="post" name="mst_service">
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Group Services</label>
                                          <div class="controls">
                                          <input type="text" name="grp_services" readonly="" value="<?=$row->item_group;?>" />
                                          <input type="hidden" name="id_group" value="<?=$row->id_item_group;?>" />
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                          <input type="text" name="item_name" readonly="" value="<?=$row->item_name;?>" />
                                          <input type="hidden" name="id_item" id="id_item"  value="<?=$row->id_item;?>" />
                                          </div>
                                        </div>
										<div class="control-group">
