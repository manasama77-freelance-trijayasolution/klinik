                            ...
                            <div class="block-content collapse in">
                                <div class="span12">           
                                      <fieldset>
										...
										<form class="form-horizontal" action="<?php echo base_url();?>client/update_client_process" method="post" name="quotation">		
										<!--
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="client_name" type="text" id="2" value="<?=$row->client_name;?>" disabled autocomplete="off" required>
                                          </div>
                                        </div>
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea name="other" id="10" autocomplete="off" disabled><?=$row->client_other;?></textarea>
                                          </div>
                                        </div>
								...
								<div class="form-actions">
								<input type="submit" class="btn btn-success" value="Submit" id="11" disabled>
                                </div>
                        </div>
									</form>
