	...
	$.fn.weatherfeed = function(locations, options, fn) {	
		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Sorry, Weather Error') {
					...
					if (options.link) html += '<div class="weatherLink"><a href="'+ feed.link +'" target="'+ options.linktarget +'" title="Read full forecast">Enjoy Your Today</a></div>';
