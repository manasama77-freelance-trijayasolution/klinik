...
b+='<div class="weatherForecastRange">High: '+a[h].high+" Low: "+a[h].low+"</div>",b+="</div>";b+="</div>"}e.link&&(b+='<div class="weatherLink"><a href="'+c.link+'" target="'+e.linktarget+'" title="Read full forecast">KYOAI MEDICAL SERVICES</a></div>')}else b='<div class="weatherItem '+m+'">',b+='<div class="weatherError">City not found</div>';b+="</div>";m="odd"==m?"even":"odd";f.append(b)},w=function(f){d=new Date;return r=new Date(d.toDateString()+" "+f)}})}})(jQuery);